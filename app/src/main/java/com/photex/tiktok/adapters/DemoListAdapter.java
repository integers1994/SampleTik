...
public class DemoListAdapter  //
    ...
    public DemoListAdapter(PlayerSelector origin, Uri videoUri) {
    ...
    public VideoPlayerListner getVideoPlayerListner() {
        return videoPlayerListner;
    }

    public void setVideoPlayerListner(VideoPlayerListner videoPlayerListner) {
...
*/
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return viewType != TYPE_VIDEO ? new UiAwareVideoViewHolder(this,
                parent,
                inflater,
                R.layout.view_holder_video) : new TextViewHolder(parent, inflater, R.layout.view_holder_text);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof UiAwareVideoViewHolder) {

            UiAwareVideoViewHolder videoViewHolder = (UiAwareVideoViewHolder) holder;
