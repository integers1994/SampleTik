...
public class MyAudiosAdapter extends RecyclerView.Adapter<MyAudiosAdapter.ViewHolder> {
    private OnItemClickListner onItemClickListner;
    private ArrayList<AudioInfo> audioList = new ArrayList<>();
    Context context;
    public static int lastPositionClicked = -1;

    public MyAudiosAdapter(Context context) {
        this.context = context;
    }

    public MyAudiosAdapter(int context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.my_audios_item, parent, false);
    ...
    public MyAudiosAdapter setOnItemClickListner(OnItemClickListner onItemClickListner) {
