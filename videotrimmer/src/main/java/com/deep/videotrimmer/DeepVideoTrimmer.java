...
import com.deep.videotrimmer.interfaces.OnLoadingThumbnail;
...
public class DeepVideoTrimmer extends FrameLayout implements MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
    ...
    OnLoadingThumbnail onLoadingThumbnail;
    ...
    private void init(Context context) {
                                                  ...
                                                  public void onClick(View view) {
                                                      ...
                                                      if (letUserProceed) {
                                                          if (mStartPosition <= 0 && mEndPosition >= mDuration) {
                                                              ...
                                                              mOnTrimVideoListener.saveAction();
                                                              mPlayView.setVisibility(View.VISIBLE);
                                                              mVideoView.pause();
        ...
        if(onLoadingThumbnail != null){
            onLoadingThumbnail.onStartLoadingThumbnail();
        }

    }

    public OnLoadingThumbnail getOnLoadingThumbnail() {
        return onLoadingThumbnail;
    }

    public void setOnLoadingThumbnail(OnLoadingThumbnail onLoadingThumbnail) {
        this.onLoadingThumbnail = onLoadingThumbnail;
    }
 ...
 /*        Adjust the size of the video
        ...
        if(onLoadingThumbnail != null){
            onLoadingThumbnail.onFinishLoadingThumbnail();
        }
    }
 ...
 /*        0 is Left selector
    ...
    private void getSizeFile(boolean isChanged) {
        if (isChanged) {
            ...
            long newSize;
            newSize = ((initSize / initialLength) *
                    (mEndPosition - mStartPosition));
            mTextSize.setText(String.format("%s %s", newSize / 1024
                    , getContext()
